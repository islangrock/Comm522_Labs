---
title: "04 Random Selection and Assignment"
author:
output: 
  html_document:
    code_folding: show
...
*This lab reviews the concepts of sample size, random assignment, and visualizing experimental results* 
...
We will use a dataset that includes information about California Schools. This is a R learning data set. The data is collected from several from K-6 or K-8 schools in 1998-1999. It includes the following variables, all totaled and averaged at the district level: 
...
The data will come from the AER package. We'll also use the tidyverse and randomizer packages in this lab. 
```{r}
...
Let's imagine that we will allow our schools to self-select into treatment for an experiment on reading scores. For some reason the schools with the most teachers all select into our treatment. 
...
What does random assignment improve over other ways of deciding treatment? 
